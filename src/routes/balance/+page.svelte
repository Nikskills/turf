...
<div class="bg-generalbackground min-h-screen">
	<div class="flex justify-start p-4">
		<div class="w-[14%]">
			<button
				class="rounded-md bg-secondary text-generalbackground py-2 text-sm font-semibold shadow-sm mx-2 my-1 w-full"
				on:click={() => (window.location.href = '/kassa')}>Terug</button
			>
		</div>
	</div>
