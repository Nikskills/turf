  ...
  <div class="container mx-auto my-8 p-4 ">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
      ...
      <div class="bg-blue-100 p-6 rounded-lg shadow-md">
        ...
        <h3 class="text-xl font-semibold mb-2 text-gray-600 text-center">Graphs</h3>
        <!-- Placeholder for Graphs -->
        <div class="h-40 bg-white rounded-md shadow-sm flex items-center justify-center text-gray-500">Graphs Placeholder</div>
      </div>
